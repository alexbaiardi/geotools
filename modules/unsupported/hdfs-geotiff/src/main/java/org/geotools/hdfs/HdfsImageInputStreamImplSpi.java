 ...
 */
public class HdfsImageInputStreamImplSpi extends ImageInputStreamSpi {
     ...
     */
    public HdfsImageInputStreamImplSpi() {
    ...
    public ImageInputStream createInputStreamInstance(
        ...
        if (LOGGER.isLoggable(Level.FINE)) {
            LOGGER.fine(
                    "HdfsImageInputStreamImplSpi.createInputStreamInstance("
                            + input.getClass()
                            + ")");
        }
        if (input instanceof HdfsImageInputStreamImpl) {
            try {
                return new HdfsImageInputStreamImpl(((HdfsImageInputStreamImpl) input).getUrl());
            } catch (IOException e) {
        ...
        try {
            ...
            return new HdfsImageInputStreamImpl(path);
        } catch (IOException e) {
